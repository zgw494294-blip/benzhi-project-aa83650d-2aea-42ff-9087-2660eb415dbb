...
基于 Go 实现的PhonemeReleaseDesk Web 项目，一款后端服务，用于支持PhonemeReleaseDesk的核心业务流程。

## 项目说明
- 项目：benzhi-project-aa83650d-2aea-42ff-9087-2660eb415dbb
- 项目用途：用于支持PhonemeReleaseDesk的核心业务流程。
- Go 工具链：`golang:1.22`
...
cd /app && GOTOOLCHAIN=local go run ./cmd/server -selfcheck -addr=127.0.0.1:19081 -data=./var/selfcheck
...
## 题目验证命令
1. 预期退出码 0：`go test ./...`
2. 预期退出码 0：`go run ./cmd/server -selfcheck -addr=127.0.0.1:19081 -data=./var/selfcheck`
